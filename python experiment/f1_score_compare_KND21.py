...
if __name__ == "__main__":
    ...
    for idx in range(1, 12):
        ...
        df_log = pd.read_csv('device_logs\\device_records_KND21.csv', sep=',')
    ...
    # 保存为 CSV 文件
    result_df.to_csv('output_F1_KND21.csv', index=False, header=True)
    print(f1)
